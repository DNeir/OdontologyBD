...
SECRET_KEY = "django-insecure-brqrma4q4@5pie!&kv_pcw*qu*k_5ylqtct6p1p#w32@4u@jy="
...
INSTALLED_APPS = [
    ...
    "myapps.patients.apps.PatientsConfig",
    "myapps.clinic.apps.ClinicConfig",
    "myapps.inventory.apps.InventoryConfig",
    "rest_framework",
    # CORS
    "corsheaders",
]
...
DATABASES = {
    "default": DATABASE_CONFIGS.get(DATABASE_ENGINE, DATABASE_CONFIGS["postgresql"])
}
